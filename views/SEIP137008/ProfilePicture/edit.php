            ...
            <div class="col-md-10 ">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <form class="form-horizontal my-form " action="update.php" method="post" enctype="multipart/form-data">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <img src="<?php echo $oneData->profile_image ?>" alt="" class="table_image">
                                        <input type="file" class="form-control" name="profile_image" placeholder="Profile Picture">
                                    </div>
                                </div>
                                <div class="form-group">

                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <form class="form-horizontal my-form " action="update.php" method="post">
                            <fieldset>
                                <legend class="project-sub-heading">Edit Gender</legend>
                                <?php
                                $fromDB = $oneData->gender;
                                ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 radio">
                                        <div class="radio">
                                            <input type="radio" name="gender" id="optionsRadios1" value="Male" <?php $fromDB==='Male' ? print 'checked' : print " " ?> >
                                            Male
                                        </div>
                                        <div class="radio">
                                            <input type="radio" name="gender" id="optionsRadios2" value="Female" <?php $fromDB==='Female' ? print 'checked' : print " " ?> >
                                            Female
                                        </div>
                                    </div>

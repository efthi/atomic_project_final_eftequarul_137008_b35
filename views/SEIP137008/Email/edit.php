    ...
    <div class="jumbotron header">
        <div class="row">
            <div class="logo col-md-4 ">
                <img src="../../../resource/assets/img/logo/email.jpg" alt="..." class="img-rounded">
            </div>
        ...
        <div class="row">
            <div class="col-md-2">
                <ul class="nav atomic-side-nav nav-pills nav-stacked " id="sidebar-ctrl">
                    ...
                    <li role="presentation" ><a href="../Email/index.php">City</a></li>
                    <li role="presentation" class="active"><a href="index.php">Email <span class="glyphicon glyphicon-play"></span></a></li>
                ...
                <div class="row">
                                ...
                                <span class="navbar-brand"> <a href="#" id="button-sidebar" class="control-link"><span class="glyphicon glyphicon-chevron-left" ></span></a>
                                 <span class="control-link">Control</span><a href="#" id="button-navbar" class="control-link"><span class="glyphicon glyphicon-chevron-right" ></span></a>
                                    ...
                                    <div class="nav navbar-nav" role="group" aria-label="..." id="navbar-ctrl">
                                        <a href="index.php" class="navbar-btn btn btn-info"><span class="glyphicon glyphicon-th-list"></span> Index</a>
                                        <a href="" class="navbar-btn btn btn-warning"><span class="glyphicon glyphicon-trash"></span> Trash Item</a>
                                        <a href="../atomic_project.php" class="navbar-btn btn btn-success"><span class="glyphicon glyphicon-th"></span> Category Page</a>
                    ...
                    <div class="col-md-12">
                        ...
                        <form class="form-horizontal my-form " action="update.php" method="post">
                            <fieldset>
                                <legend class="project-sub-heading">Update Email Address</legend>

                                <div class="form-group">
                                    <div class="col-sm-10 ">
                                        <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $oneData->id ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="email" class="col-sm-2 control-label">Author Name</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="email" name="email" value="<?php echo $oneData->emailaddress ?>" required autofocus>
                                    </div>
                                </div>

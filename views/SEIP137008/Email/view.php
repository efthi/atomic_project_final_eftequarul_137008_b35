                        ...
                        <div class="">
                            <div class="panel panel-success">
                                ...
                                <p class="text-left view-style fade-in one">
                                    ...
                                    <i class="fa fa-pencil fa-fw" aria-hidden="true"></i>
                                    <span class="view-line">Person Name </span><span class="glyphicon glyphicon-arrow-right"></span>
                                    <?php echo $oneData->name."<br>"?>

                                    <i class="fa fa-pencil fa-fw" aria-hidden="true"></i>
                                    <span class="view-line">Email Address </span><span class="glyphicon glyphicon-arrow-right"></span>
                                    <?php echo $oneData->emailaddress."<br>"?>

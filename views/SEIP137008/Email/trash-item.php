...
$allData = $emailnfo->trashitem('obj');

################## search  block 1 of 5 start ##################
if(isset($_REQUEST['search']) )$allData =  $emailnfo->search($_REQUEST);
$availableKeywords=$emailnfo->getAllKeywords();
...
$someData = $emailnfo->trashedPaginator($page,$itemsPerPage);
...
if(isset($_REQUEST['search']) ) {
    $someData = $emailnfo->search($_REQUEST);
    $serial = 1;
}
    ...
    <div class="jumbotron header">
        <div class="row">
            <div class="logo col-md-4 ">
                <img src="../../../resource/assets/img/category-image/email.jpg" alt="..." class="img-rounded">
            </div>
                    ...
                    <div class="col-md-12">
                        <table class="table table-bordered table-hover table-responsive my-table-border my-td fade-in one">
                            ...
                            foreach($someData as $oneData){
                                ...
                                echo "<td>$oneData->emailaddress</td>";
                                echo " <td>

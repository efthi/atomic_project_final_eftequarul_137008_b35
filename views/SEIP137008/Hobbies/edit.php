...
$hobbyinfo->setData($_GET);
$oneData = $hobbyinfo->view('obj');
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <form class="form-horizontal my-form " action="update.php" method="post">
                            <fieldset>
                                <legend class="project-sub-heading">Edit Hobbies</legend>
                                ...
                                <div class="form-group">
                                    ...
                                    $fromDatabase = explode(",", $fromDatabase);

                                    ?>
                                    <label for="hobbies" class="col-sm-2 control-label">Hobbies</label>
                                    <div class="col-sm-6 radio">
                                        <div class="checkbox-inline">
                                            <input type="checkbox" name="hobbies[]" id="inlineCheckbox1" value="Reading"
                                                <?php in_array("Reading", $fromDatabase) ? print "checked" : " "  ?> > Reading
                                            <br>
                                            <input type="checkbox" name="hobbies[]" id="inlineCheckbox2" value="Writting"
                                                <?php in_array("Writting", $fromDatabase) ? print "checked" : " "  ?> > Writting
                                            <br>
                                            <input type="checkbox" name="hobbies[]" id="inlineCheckbox3" value="Coding"
                                                <?php in_array("Coding", $fromDatabase) ? print "checked" : " "  ?> > Coding
                                            <br>
                                            <input type="checkbox" name="hobbies[]" id="inlineCheckbox3" value="Cooking"
                                                <?php in_array("Cooking", $fromDatabase) ? print "checked" : " "  ?>> Cooking
                                            <br>
                                            <input type="checkbox" name="hobbies[]" id="inlineCheckbox3" value="Travelling"
                                                <?php in_array("Travelling", $fromDatabase) ? print "checked" : " "  ?> > Travelling
                                            <br>
                                            <input type="checkbox" name="hobbies[]" id="inlineCheckbox3" value="Fighting"
                                                <?php in_array('Fighting', $fromDatabase) ? print "checked" : " ";  ?> > Fighting
                                            <br>
                                        </div>
                                    </div>
